...
class DetailsPage_new extends StatefulWidget {

  FoodItem data;
  DetailsPage_new({Key? key, required this.data}) : super(key: key);

  @override
  State<DetailsPage_new> createState() => _DetailsPage_newState();
}

class _DetailsPage_newState extends State<DetailsPage_new> {
